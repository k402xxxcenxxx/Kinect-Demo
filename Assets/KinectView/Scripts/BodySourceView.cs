...
public class BodySourceView : MonoBehaviour 
{
    ...
    public Material filterdMaterial;

    public float fSmoothing = 0.5f;
    public float fCorrection = 0.5f;
    public float fPrediction = 0.4f;
    public float fJitterRadius = 0.3f;
    public float fMaxDeviationRadius = 0.06f;
    ...
    public JointFilter m_JointFilter;

    void Start() {
        m_JointFilter = new JointFilter();
        m_JointFilter.Init(fSmoothing, fCorrection, fPrediction, fJitterRadius, fMaxDeviationRadius);
    }
    ...
    void Update () 
    {
        ...
        foreach(var body in data)
        {
            ...
            if(body.IsTracked)
            {
                ...
                if (filter)
                {
                    RefreshFilteredBodyObject(body, _Bodies[body.TrackingId]);
                }
                else
                {
